package com.example.mana.newsfinder.ui.screens.activities.mainactivity.fragments.home.adapter;
...
public class NewsAdapter extends BaseRecyclerAdapter<news.articles, BaseViewHolder> {
  ...
  @Override public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View view = inflater.inflate(R.layout.nf_single_article, parent, false);
